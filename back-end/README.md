...
- A lista de usuários deve ser obtida [através do arquivo json](#importação-de-dados)
...
- A lista de channels deve ser obtida através [através do arquivo json](#importação-de-dados)
